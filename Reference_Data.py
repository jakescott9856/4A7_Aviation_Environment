...
W_mp = 40 #tonne, Maximum payload
W_e = 106 #tonne, Empty weight
W_fmp = 73 #tonne, Fuel capacity at max payload
W_mto = 220 #tonne, Max take-off weight
V_cruise = 256 #m/s, Cruise TAS
M_cruise = 0.85 #Cruise Mach number
h_cruise = 9.5 #31000ft Initial cruise altitude
